Shader "Simple Toon/SToon Outline"
{
	Properties
	{
		...
		_Steps("Steps", Range(1,25)) = 2.7
		_StpSmooth("Smoothness", Range(0,1)) = 0.205
		_Offset("Lit Offset", Range(-1,1.1)) = 0.23

		[Header(Light)][Space(5)]  //light
		[Toggle] _Clipped("Clipped", Float) = 0
		_MinLight("Min Light", Range(0,1)) = 0.563
		_MaxLight("Max Light", Range(0,1)) = 1
		_Lumin("Luminocity", Range(0,2)) = 0.7

		[Header(Outline)][Space(5)]  //outline
		_OtlColor("Color", COLOR) = (0,0,0,1)
		_OtlWidth("Width", Range(0,5)) = 2

		[Header(Shine)][Space(5)]  //shine
		[HDR] _ShnColor("Color", COLOR) = (0.94,1,0.73,1)
		[Toggle] _ShnOverlap("Overlap", Float) = 0

		_ShnIntense("Intensity", Range(0,1)) = 0.244
		_ShnRange("Range", Range(0,1)) = 0.258
		_ShnSmooth("Smoothness", Range(0,1)) = 1
	}
